...
public class GoRenameVarQuickFixTest extends GoQuickFixTestBase {
  public static final String RENAME_TO = "Rename to _";
  ...
  protected String getTestDataPath() {
    return "testData/quickfixes/rename-var/";
  }

  public void testSimple()      { doTest(RENAME_TO);      }
  public void testProhibited()  { doTestNoFix(RENAME_TO); }
}
