...
public interface GoTokenTypes {
  ...
  TokenSet NUMBERS = TokenSet.create(INT, HEX, OCT, FLOAT, DECIMAL_I, FLOAT_I);
  TokenSet KEYWORDS = TokenSet.create(PACKAGE, IMPORT, BREAK, CASE, CHAN, CONST, CONTINUE, DEFAULT, DEFER,
      ELSE, FALLTHROUGH, FOR, FUNC, GO, GOTO, IF, IMPORT, INTERFACE, MAP, PACKAGE, RANGE, RETURN,
      SELECT, STRUCT, SWITCH, TYPE, VAR);
  TokenSet OPERATORS = TokenSet.create(EQ, ASSIGN, NOT_EQ, NOT, PLUS_PLUS,
