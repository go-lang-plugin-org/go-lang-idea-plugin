...
public interface GoTokenTypes {
  ...
  TokenSet NUMBERS = TokenSet.create(litINT, litHEX, litOCT, litFLOAT, litDECIMAL_I, litFLOAT_I);
  TokenSet KEYWORDS = TokenSet.create(kPACKAGE, kIMPORT, kBREAK, kCASE, kCHAN, kCONST, kCONTINUE, kDEFAULT, kDEFER,
      kELSE, kFALLTHROUGH, kFOR, kFUNC, kGO, kGOTO, kIF, kIMPORT, kINTERFACE, kMAP, kPACKAGE, kRANGE, kRETURN,
      kSELECT, kSTRUCT, kSWITCH, kTYPE, kVAR);
  TokenSet OPERATORS = TokenSet.create(oEQ, oASSIGN, oNOT_EQ, oNOT, oPLUS_PLUS,
      oPLUS_ASSIGN, oPLUS, oMINUS_MINUS, oMINUS_ASSIGN, oMINUS, oCOND_OR, oBIT_OR_ASSIGN, oBIT_OR, oBIT_CLEAR_ASSIGN,
      oBIT_CLEAR, oCOND_AND, oBIT_AND_ASSIGN, oBIT_AND, oSHIFT_LEFT_ASSIGN, oSHIFT_LEFT, oSEND_CHANNEL, oLESS_OR_EQUAL,
      oLESS, oBIT_XOR_ASSIGN, oBIT_XOR, oMUL_ASSIGN, oMUL, oQUOTIENT_ASSIGN, oQUOTIENT, oREMAINDER_ASSIGN,
