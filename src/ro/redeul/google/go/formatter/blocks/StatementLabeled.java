 ...
 */
public class StatementLabeled extends Code<GoLabeledStatement> {
    ...
    public StatementLabeled(GoLabeledStatement labeledStatement, CommonCodeStyleSettings settings,
                            Indent indent,
