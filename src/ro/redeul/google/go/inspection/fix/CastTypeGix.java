...
public class CastTypeGix extends LocalQuickFixAndIntentionActionOnPsiElement {

    private PsiFile workingFile = null;

    public CastTypeGix(@Nullable PsiElement element) {
        super(element);
    }


    public CastTypeGix(PsiElement element, PsiElement resolve) {
        super(element);
    }

    public CastTypeGix(PsiElement element, PsiFile workingFile) {
        super(element);
    ...
    public String getText() {
        return "Cast Type \"" + getStartElement().getText() + "\"";
    }
