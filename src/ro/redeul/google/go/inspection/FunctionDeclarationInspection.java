...
public class FunctionDeclarationInspection {
    ...
    public FunctionDeclarationInspection(InspectionManager manager) {
        this.manager = manager;
    }

    public ProblemDescriptor[] checkFunction(GoFunctionDeclaration function) {
        Context ctx = new Context(manager, function);
        ctx.hasResultButNoReturnAtTheEnd();
        ctx.hasDuplicateArgument();
        ctx.hasRedeclaredParameterInResultList();
        ctx.hasReturnParameterQuantityUnmatch();
    ...
    private static class Context {
        ...
        private Context(InspectionManager manager, GoFunctionDeclaration function) {
            this.manager = manager;
        ...
        private boolean hasResult() {
            return function.getResults() != null;
        }
