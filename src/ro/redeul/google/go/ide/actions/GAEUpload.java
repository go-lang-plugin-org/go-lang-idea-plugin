 ...
 * Date: 21/07/11
 */
public class GAEUpload extends AnAction {
    ...
    public void actionPerformed(AnActionEvent anActionEvent) {
        ...
        if (GAEUpload.consoleView == null)
            GAEUpload.consoleView = TextConsoleBuilderFactory.getInstance().createBuilder(project).getConsole();
