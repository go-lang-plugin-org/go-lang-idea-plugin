...
public class GoSwitchExpressionStatementImplPsi extends GoDocumentedPsiElementBase implements GoSwitchExpressionStatement {

    public GoSwitchExpressionStatementImplPsi(@NotNull ASTNode node) {
        super(node);
    }
