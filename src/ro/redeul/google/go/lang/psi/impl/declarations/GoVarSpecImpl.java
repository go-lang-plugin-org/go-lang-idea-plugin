...
public class GoVarSpecImpl extends GoDocumentedPsiElementBase implements GoVarSpec {

    public GoVarSpecImpl(@NotNull ASTNode node) {
        super(node);
    }
    ...
    public <T, S> T accept(GoTypedVisitor<T, S> visitor, S data) {
        return visitor.visitVarSpec(this, data);
    }
