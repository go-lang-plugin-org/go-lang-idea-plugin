...
//
    ...
    public final TokenSet LOG_AND_OPS = TokenSet.create(oCOND_AND);
    public final TokenSet LOG_OR_OPS = TokenSet.create(oCOND_OR);

    public final TokenSet MUL_OPS = TokenSet.create(
            oMUL, oQUOTIENT, oREMAINDER, oSHIFT_LEFT, oSHIFT_RIGHT, oBIT_AND, oBIT_CLEAR
    );

    public final TokenSet ADD_OPS = TokenSet.create(
            oPLUS, oMINUS, oBIT_OR, oBIT_XOR
    );

    public final TokenSet REL_OPS = TokenSet.create(
            oEQ, oNOT_EQ, oLESS, oLESS_OR_EQUAL, oGREATER, oGREATER_OR_EQUAL
    );

    public final TokenSet BINARY_OPS = TokenSet.orSet(
            LOG_AND_OPS,
            LOG_OR_OPS,
            REL_OPS,
            MUL_OPS,
