...
public class GoAssignmentImpl extends GoCompositeElementImpl implements GoAssignment {

  public GoAssignmentImpl(ASTNode node) {
    super(node);
  }

  public void accept(@NotNull PsiElementVisitor visitor) {
    if (visitor instanceof GoVisitor) ((GoVisitor)visitor).visitAssignment(this);
